...
// The master HTML remains unchanged. The durable save layer is injected only
// for the Windows application build.
...
func main() {
    ...
    page = page[:len(page)-len("</body></html>")] + `<script src="/save-fix.js"></script></body></html>`
